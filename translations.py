...
modifier_strings = {
    "EN": {
        ...
        "app_id_usage": "Usage: /id <bundle_id> or /b <bundle_id> (e.g., xyz.turannul.newbundleID).",
        ...
        "set_remove_architectures": "Architectures {architectures} have been marked for removal.",
